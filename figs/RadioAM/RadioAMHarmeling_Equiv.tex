...
\begin{circuitikz}[scale=0.95, transform shape,american] 
    ...
    to [C,l2=$C_{2}$ and 470 \si{\nano\farad},name=Condo_hp, label distance =4pt]
     ++(1.5,0)  
     to [R,l2=$R_{1}$ and 150\si{\ohm},name=R_1,label distance =9pt]++(1,0) 
     to[R,l2=$R_{2}$ and 1.35\si{\kilo\ohm},name=R_2,label distance =9pt]++(2,0)
     coordinate (rCHP);
    ...
    (R_1.right) ++(0.3,0) node[circ]{}  -- ++(0,1.5) 
     to [R,l2=$R_{g}$ and 1.2\si{\kilo\ohm},name=R_gain,label distance =9pt] ++(1.2,0)
      ...
      ++(1.2,0) coordinate(gr) --  (LM386.-) node[circ]{} ;
    \draw
    (gr)node[circ]{} 
    to [R,l2=$R_{3}$ and 30\si{\kilo\ohm},name=R_3,label distance =9pt] 
