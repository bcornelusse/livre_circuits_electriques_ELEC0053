...
\begin{circuitikz}[scale=0.95, transform shape,american] 
    ...
    \draw
    (P.wiper)-- ++(0.5,0) 
    to [C,l2=$C_{2}$ and 470 \si{\nano\farad},name=Condo_hp, label distance =4pt]
    ++(1.5,0)  
    ...
    %Input Resistor AO
    \draw
    (Condo_hp.right)++(0.6,0)coordinate(Rin)node[circ]{}
    to[R,l2=$R_{2}$ and 50\si{\kilo\ohm},name=R_2,label distance =9pt] 
    (Rin |-groundAO)node[ground]{};
    ...
    %Gain R and C
    \draw
    (R_1.right) ++(0.3,0) node[circ]{}  -- ++(0,1.5) 
    ...
    (C_gain.right -| LM386.out)--(LM386.out)node[circ]{} ;

    

    \draw
    (LM386.out)-- ++(2,0) 
    to [cC,l2=$C_{3}$ and 270\si{\micro\farad},name=C_3, label distance = 4pt]
     ++(1.2,0);
