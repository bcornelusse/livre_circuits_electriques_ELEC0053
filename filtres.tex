...
\textit{Ce chapitre, grâce aux notions introduites au Chapitre~\ref{sec:sinusoidal}, permet de porter un regard nouveau sur l'analyse des circuits électriques en utilisant les concepts de "Signaux et Systèmes", qui sont d'abord brièvement rappelées, puis particularisées à des circuits simples et enfin illustrés sur l'exemple de la radio AM.}
...
\caption{Circuit résonant de la radio AM.}
