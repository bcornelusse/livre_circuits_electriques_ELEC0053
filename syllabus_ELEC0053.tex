...
{% begin code
	...
	\textbf{\large Exercice~\theexercise~ #1}%
...
{% begin code
	\refstepcounter{exercise}%
	\par\vspace{\baselineskip}\noindent
	\textbf{\large Exercice~\theexercise~ #1} \textit{Solution à la page \pageref{#2}.}%
		\par\vspace{\baselineskip}\noindent\ignorespaces
}%
{% end code
	\ignorespacesafterend
...
{% begin code
	...
	\par\vspace{\baselineskip}\noindent
	\textbf{\large Solution de l'exercice~#1}%
	\par\vspace{\baselineskip}\noindent\ignorespaces
}%
{% end code
	\ignorespacesafterend \hfill $\blacksquare$ 
}
...
\par\textit{Third printing, \monthyear}
\end{fullwidth}
